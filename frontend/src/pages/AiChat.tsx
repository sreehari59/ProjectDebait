    ...
    <div className="min-h-screen bg-gradient-to-br from-background to-secondary/20 p-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <h1 className="text-3xl font-orbitron font-bold text-primary">AI Agent Chat</h1>
          <div></div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <Card className="bg-card/50 backdrop-blur-sm border-2 border-primary/20">
            <CardHeader>
              <CardTitle className="text-xl font-orbitron text-center">AI Agent</CardTitle>
            </CardHeader>
            <CardContent className="p-6">
              <div className="relative aspect-video bg-gradient-to-br from-primary/10 to-accent/20 rounded-lg overflow-hidden border-2 border-primary/30">
                {/* Placeholder for video - will be replaced with actual video stream */}
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className={`w-32 h-32 rounded-full bg-primary/20 flex items-center justify-center transition-all duration-500 ${
                    isAgentSpeaking ? 'scale-110 bg-primary/30' : 'scale-100'
                  }`}>
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-card/50 backdrop-blur-sm border-2 border-primary/20">
              <CardHeader>
                <CardTitle className="text-lg font-orbitron">Voice Controls</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground text-center">
                  {isListening 
                    ? "Listening... Speak to the AI agent" 
                    : "Click to start your conversation with the AI agent"
                  }
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-judge/10 border-2 border-judge/30">
              <CardHeader>
                <CardTitle className="text-lg font-orbitron text-judge">Request Judgment</CardTitle>
              </CardHeader>
              <CardContent>
                <Button
            ...
            <Card className="bg-card/50 backdrop-blur-sm border-2 border-primary/20">
              <CardHeader>
                <CardTitle className="text-lg font-orbitron">Session Status</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className={isAgentSpeaking ? "text-blue-600 font-medium" : "text-gray-500"}>
